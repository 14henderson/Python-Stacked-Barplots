<p align="center">
    <img src="https://github.com/14henderson/Python-Stacked-Barplots/blob/main/readmefigures/Likert-example-graph.png?raw=true" width=100% alt="Example Horizontal Stacked Barchart created using this library, showing Likert-scale data.">
</p>
...
<p align="center">
    <img src="https://github.com/14henderson/Python-Stacked-Barplots/blob/main/readmefigures/Example-Graph-2.png?raw=true" width=60% alt="Example 2 Horizontal Stacked Barchart created using this library.">
</p>
...
<p align="center">
    <img src="https://github.com/14henderson/Python-Stacked-Barplots/blob/main/readmefigures/Example-Graph-3.png?raw=true" width=60% alt="Example 3 Horizontal Stacked Barchart created using this library.">
</p>
